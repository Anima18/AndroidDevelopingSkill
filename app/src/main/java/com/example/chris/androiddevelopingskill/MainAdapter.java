...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    private List<ActivityClass> dList;
    ...
    public MainAdapter(Context context, List<ActivityClass> dList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ActivityClass activityClass = dList.get(position);
        holder.titleTv.setText(activityClass.getActivityName());
    }
